DROP IF EXISTS cartao;
DROP IF EXISTS  pessoa cascade;
DROP IF EXISTS avaliacao ;
DROP IF EXISTS bairro cascade;
DROP IF EXISTS cep cascade;
DROP IF EXISTS cidade cascade;
DROP IF EXISTS contato;
DROP IF EXISTS endereco;
DROP IF EXISTS estado;
DROP IF EXISTS servico cascade;
DROP IF EXISTS servico_contratado;
DROP IF EXISTS servico_descricao;
